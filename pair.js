    ...
    const {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let desc = `*Hello there RASHU MD User! 👋🏻* 

> Do not share your session id with your gf 😂.

 *Thanks for using ‼️𝐐𝐔𝐄𝐄𝐍 𝐑𝐀𝐒𝐇𝐔 𝐌𝐃 ❤️‍🩹 🚩* 
...
https://github.com/CyberRushModz0
...
{quoted:code })
                            ...
                            let desc = `*Don't Share with anyone this code use for deploy RASHU-MD*\n\n ◦ *Github:* https://github.com/CyberRushModz0`;
                            await sock.sendMessage(sock.user.id, {
text: desc,
contextInfo: {
externalAdReply: {
